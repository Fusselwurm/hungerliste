...
//                    energyPerKg: parseInt(xpathGetFirst(xpathExpressions.energyPer100g, row), 10) * 10,
                    energyPerKg: numberFromDomText(xpathGetFirst(xpathExpressions.energyPer100g, row)) * 10,
                    //massInKg: parseInt(xpathGetFirst(xpathExpressions.mass, row), 10) / 1000
                    massInKg: numberFromDomText(xpathGetFirst(xpathExpressions.mass, row)) / 1000
                };
